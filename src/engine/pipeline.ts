...
export const PARAM_MAP: [DevelopKey, string][] = [
  ...
  ['sharpenDetail', 'uSharpenDetail'],
  ['sharpenMasking', 'uSharpenMasking'],
  ['noiseReduction', 'uNoiseReduction'],
  ['colorNoiseReduction', 'uColorNoiseReduction'],
  ['vignette', 'uVignette'],
  ['vignetteMidpoint', 'uVignetteMidpoint'],
  ['vignetteFeather', 'uVignetteFeather'],
  ['vignetteRoundness', 'uVignetteRoundness'],
  ['grain', 'uGrain'],
  ['grainSize', 'uGrainSize'],
  ['grainRoughness', 'uGrainRoughness'],
  ['texture', 'uTexture'],
  ['clarity', 'uClarity'],
  ['dehaze', 'uDehaze'],
]
